...
if (Test-Path $binaryModulePath) {
    Import-Module $binaryModulePath
    # Register type accelerators so [ModuleFastSpec] and [ModuleFastInfo] work without namespace
    $accelerators = [psobject].Assembly.GetType('System.Management.Automation.TypeAccelerators')
    if (-not $accelerators::Get.ContainsKey('ModuleFastSpec')) {
        $accelerators::Add('ModuleFastSpec', [ModuleFast.ModuleFastSpec])
    }
